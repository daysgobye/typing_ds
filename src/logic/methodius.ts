export class Methodius {
   ...
   */
  static hasPunctuation(string: string): boolean {
   ...
   */
  static hasSpace(string: string): boolean {
   ...
   */
  static sanitizeText(string: string): string {
    return string
   ...
   */
  static getNGrams(text: string, gramSize: number = 2): string[] {
    const bigrams = [];
   ...
   */
  static getWordNGrams(text: string, gramSize: number = 2): string[][] {
   ...
   */
  static getFrequencyMap(ngramArray: string[]): Map<string, number> {
   ...
   */
  static getPercentMap(frequencyMap: Map<string, number>): Map<string, number> {
   ...
   * @returns {Map<string, number>} - map of ngrams and their frequencies
   */
  static getTopGrams(frequencyMap: Map<string, number>, limit: number = 20): Map<string, number> {
  ...
  static getBottomGrams(frequencyMap: Map<string, number>, limit: number = 20): Map<string, number> {
    const orderedGrams = [...frequencyMap].sort(
      (entry1, entry2) => entry2[1] - entry1[1]
    );

    const topGrams = orderedGrams.reverse().slice(0, limit);
   ...
   */
  static getIntersection(iterable1: Map<any, any> | Array<any>, iterable2: Map<any, any> | Array<any>): Array<string> {
   ...
   */
  static getDisjunctiveUnion(iterable1: Map<any, any> | Array<any>, iterable2: Map<any, any> | Array<any>): Array<Array<any>> {
    const array1 = Array.isArray(iterable1) ? iterable1 : [...iterable1.keys()];
    const array2 = Array.isArray(iterable2) ? iterable2 : [...iterable2.keys()];
   ...
   */
  static getComparison(iterable1: Map<any, any> | Array<any>, iterable2: Map<any, any> | Array<any>): Map<any, any> {
    //@ts-ignore
    return new Map([
   ...
   */
  static getWordPlacementForNGram(ngram: string, wordsArray: Array<string>): Map<string, number> {
   ...
   */
  static getWordPlacementForNGrams(ngrams: Array<string>, wordsArray: Array<string>): Map<string, Map<string, number>> {
   ...
   */
  get letterFrequencies(): Map<string, number> {
   ...
   */
  get bigramFrequencies(): Map<string, number> {
   ...
   */
  get trigramFrequencies(): Map<string, number> {
   ...
   */
  get wordFrequencies(): Map<string, number> {
   ...
   */
  get letterPercentages(): Map<string, number> {
   ...
   */
  get bigramPercentages(): Map<string, number> {
   ...
   */
  get trigramPercentages(): Map<string, number> {
   ...
   */
  get letterPositions(): Map<string, Map<string, number>> {
   ...
   * @returns {Map<string, Map<string, number>>} - Map of letter placements in words
   */
  get bigramPositions(): Map<string, Map<string, number>> {
   ...
   * @returns {Map<string, Map<string, number>>} - Map of letter placements in words
   */
  get trigramPositions(): Map<string, Map<string, number>> {
   ...
   */
  getLetterNGrams(size: number = 2): string[] {
   ...
   */
  getTopLetters(limit: number = 10): Map<string, number> {
   ...
   */
  getTopBigrams(limit: number = 20): Map<string, number> {
   ...
   */
  getTopTrigrams(limit: number = 20): Map<string, number> {
   ...
   * @returns {Map<string, number>} - map of trigrams and their frequencies
   */
  getTopWords(limit: number = 20): Map<string, number> {
   ...
   */
  compareTo(methodius: Methodius): Map<string, Map<any, any>> {
